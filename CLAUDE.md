...
**Cost model**: ~$12/mo (CX33 VM €8.49 + Hetzner backups €1.70 + Backblaze B2 < $0.30 + free monitoring tiers).
...
## Recent Changes
- 2026-06-24: 012-cloud-deployment-docker — containerized stack (Docker Compose), Hetzner CX33 target, Cloudflare front, Backblaze B2 backups, CI/CD via GitHub Actions. cPanel deployment deprecated.
